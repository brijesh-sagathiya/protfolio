...
const ProjectCard = ({ project, delay = 0, isExpanded = false, onToggle }: ProjectCardProps) => {
  ...
  return (
    ...
    >
      <div
        className={`rounded-xl border bg-black/30 backdrop-blur-sm transition-all duration-300 ${
          isExpanded
            ...
            >
              <div className="p-6 pt-0 sm:p-8">
                <div className="space-y-6">
                  ...
                  >
                    <h4 className="font-medium text-white">About the Project</h4>
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map((tech, index) => (
                        <motion.span
                          key={index}
                          className="rounded-full bg-white/5 px-3 py-1 text-sm text-gray-300 transition-colors duration-300 hover:bg-white/10 hover:text-white"
                          initial={{ opacity: 0, y: 10 }}
                          animate={{ opacity: 1, y: 0 }}
                          transition={{
                            duration: 0.3,
                  ...
                  >
                    ...
                    <ul className="space-y-3">
                      {project.achievements.map((achievement, index) => (
                        <motion.li
                          key={index}
                          className="group/item flex items-start gap-3 text-gray-400 transition-colors hover:text-white"
                        ...
                        >
                          <div className="mt-1 h-4 w-4 flex-shrink-0">
                            <ArrowRight className="h-4 w-4 transform text-blue-400 opacity-0 transition-all duration-300 group-hover/item:translate-x-1 group-hover/item:opacity-100" />
                          </div>
                  ...
                  >
                    <motion.div
                      className="rounded-lg bg-white/5 p-3 backdrop-blur-sm transition-colors hover:bg-white/10"
